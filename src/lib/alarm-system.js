...
const camera = new RaspiCam({
    output: `./saved-pictures/villian-${newStamp}.jpeg`,
    mode: 'photo',
});
...
// -----Sound Assets-----------------------------------------------------------------------------
// const armedSound = new Sound('./sound-assets/vin-armed');
// const armingSound = new Sound('./sound-assets/vin-arming.wav');
// const motionSound = new Sound('./sound-assets/vin-motion.wav');
// const alarmSound = new Sound('./sound-assets/vin-alarm.wav');
// const disarmedSound = new Sound('./sound-assets/vin-disarmed.wav');
...
module.exports = class AlarmControls {
    ...
    disarmSystem() {
        if (disarmed.readSync() === 0) {
            ...
            loggerl.log(logger.INFO, 'System Already Disabled');
        }
    }
};
